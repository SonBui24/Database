-- tao database studen_cms_plusplus
CREATE DATABASE IF NOT EXISTS studen_cms_plusplus CHARACTER SET utf8mb4;

-- tao table student
CREATE TABLE IF NOT EXISTS student.studen_cms_plusplus(
...
-- tao table class
CREATE TABLE IF NOT EXISTS class.studen_cms_plusplus(
id 	INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
username VARCHAR(45) NOT NULL,
